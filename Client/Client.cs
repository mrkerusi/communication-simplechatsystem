...
namespace Client
{
    ...
    {
        /*All Functions here are self explainatory by its name*/
        ...
        {
                string TargetPerson = lstClients.SelectedItem.ToString();
                SelectedName.Text = "PM with " + TargetPerson;
        }

        private void label2_Click(object sender, EventArgs e)
        {
            lstClients.SelectedItem = 0;
        }
